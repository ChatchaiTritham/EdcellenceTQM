@echo off
REM EdcellenceTQM - Quick GitHub Upload Script (Windows)
REM Run this to upload all changes to GitHub
...
REM Remove deprecated files
git rm -f DEPLOYMENT_GUIDE.md 2>nul
